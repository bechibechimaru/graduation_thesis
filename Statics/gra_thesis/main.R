...
# 記述統計: 投票参加意向・オンライン投票利用意向・政治関心・SNS利用頻度の記述統計（平均・標準偏差・最小値・最大値・有効ケース数）
...
yosoku_techT <- genpr(dpr = dn_online, mpr = mctechT, setx = "techH", setxvals = c(0, 1))
